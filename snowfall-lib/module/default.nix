              ...
              let
                ...
                user-module =
                  if isFunction imported-user-module then
                    imported-user-module (modified-args // { _name = metadata.name; })
                  else if isFunction transform then
                    transform (imported-user-module // { _name = metadata.name; } // modified-args)
                  else
